...
import 'package:astra/configs/agora_config.dart';
...
class _CallScreenState extends State<CallScreen> {
  ...
  addPostFrameCallback() {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      ...
      callStreamSubscription = callMethods
        ...
        switch (ds.data) {
          // call is hanged and thus documents are deleted
          case null:
  ...
  void _addAgoraEventHandlers() {
    ...
    // joins again maybe network connectivity problems
    ...
    // when goes offline by leaving a channel or when data packet of user or host is received
    ...
    // when a local user registers an account successfully
    ...
    // when person leaves the channel
    ...
    // when connection is lost with agora sdk
    ...
    // when first frame of video call is drawn
    ...
    return Scaffold(
      ...
      body: Center(
        child: Stack(
          children: <Widget>[
            _viewRows(),
            // contains mute button, call end button, switch camera button
            _toolbar(),
          ],
        ),
      ),
